package co.com.ceiba.dna.parking.zuulserver.security;
...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.requestMatchers().antMatchers("/privada", "/estacionamiento/*").and().authorizeRequests()
				.antMatchers("/privada", "/estacionamiento/*").access("hasRole('USER')").and().requestMatchers()
